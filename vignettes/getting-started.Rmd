...
Supported authorities: `col`, `itis`, `gbif`, `ncbi`, `ott`, `fb`,
`slb`, `wd`, `iucn`, `itis_test`. The database is downloaded once and
cached locally, ensuring reproducibility — results do not depend on an
